...
const itemStyles = tv({
	...
	variants: {
		isSelected: {
			...
			true:
				"bg-blue-100 dark:bg-blue-700/30 hover:bg-blue-200 dark:hover:bg-blue-700/40 border-y-blue-200 dark:border-y-blue-900 z-20"
		},
		isDisabled: {
			true:
...
export function TreeItemContent({ children, ...props }: TreeItemContentProps) {
	return (
		<AriaTreeItemContent {...props}>
			{({ selectionMode, selectionBehavior, hasChildItems, allowsDragging, isExpanded, isDisabled }) => (
